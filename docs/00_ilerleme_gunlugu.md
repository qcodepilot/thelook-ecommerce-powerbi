...
**TÜM EKSİKLER KAPANDI ✅:** hafta içi/sonu, müşteri yaşam süresi, marka performansı, kaynak-dönüşüm, etkileşim metrikleri, kanal getirisi/ROI, segment×kanal. Tüm cevaplanabilir sorular cevaplandı.
**KALAN = sadece teslim/cila:** (1) grafik başlıklarını düzelt (otomatik "ölçütüne göre..." başlıkları), (2) tema, (3) PDF export, (4) pbix OneDrive linki → README.
